...
const HABIT_KEYWORD_MAP = [
  {
    keywords: ["water", "drink", "drinking", "glass", "glasses", "hydrat"],
    hints: ["drink water", "water"],
  },
  {
    keywords: [
      "exercise",
  ...
  {
    keywords: ["sleep", "sleeping", "bed", "bedtime", "night"],
    hints: ["sleep"],
  },
  {
    keywords: ["wake", "woke", "waking", "morning", "rise", "alarm"],
    hints: ["wake up"],
  },
  {
    keywords: ["read", "reading", "book", "books", "page", "pages", "chapter"],
    hints: ["read"],
  },
  {
    keywords: ["meditat", "meditation", "mindful", "breathe", "breathing"],
    hints: ["meditate"],
  },
  {
    keywords: ["walk", "walked", "walking", "step", "steps", "stroll"],
    hints: ["walk", "daily walk"],
  },
  {
    keywords: [
      "medicine",
    ...
    hints: ["medicine", "take medicine"],
  },
  {
    keywords: ["journal", "journaling", "diary", "wrote", "write", "writing"],
    hints: ["journal"],
  },
...
export function parseVoiceCommand(text, habits) {
  ...
  if (h.type === "one_time") {
    const oneTimeTriggers =
      /\b(done|finished|completed|did|marked|complete)\b/.test(text);
  ...
  if (h.type === "countable" || h.type === "big_number") {
    const num = extractNumber(text);
    const hasTrigger =
      /\b(logged|drank|drunk|had|did|added|drank|took|drunk|consumed)\b/.test(
        text,
      );
