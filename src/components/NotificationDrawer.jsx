          ...
          >
            ...
            <div className="flex-1 overflow-y-auto flex flex-col">
              ...
              Notification.permission !== "granted" ? (
                <NotificationManager onComplete={loadNotifications} />
              ) : (
                <div className="p-4 flex flex-col gap-3 h-full">
                  {notifications.length === 0 ? (
                    <div className="py-10 flex flex-col items-center justify-center text-[var(--text-muted)] opacity-60 h-full">
                      <svg
                    ...
                    notifications.map((notif) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 pr-6">
                          ...
                          <p className="text-xs text-[var(--text-secondary)] leading-tight mb-2 line-clamp-2">
                            {notif.body}
                          </p>
                          <span className="text-[10px] font-semibold text-[var(--accent-purple)] uppercase tracking-wider">
                            {getRelativeTime(notif.timestamp)}
                          </span>
                        </div>
                        <button
                          onClick={(e) => handleDismiss(e, notif.id)}
                          className="absolute top-2 right-2 p-1.5 text-[var(--text-muted)] hover:text-[var(--text-primary)] rounded-lg hover:bg-[var(--bg-card-hover)] transition-colors"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
