...
export default function BadgeCelebration() {
  ...
  return (
    <div className="fixed inset-0 z-[1200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-300">
      <div className="bg-[var(--bg-primary)] border border-amber-500/30 rounded-2xl p-8 max-w-sm w-full text-center shadow-[0_0_50px_rgba(251,191,36,0.2)] transform animate-in zoom-in-95 duration-500">
