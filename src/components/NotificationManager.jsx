...
export default function NotificationManager({ onComplete }) {
  ...
  if (permissionState === 'denied') {
    return (
      <div className="w-full flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <h4 className="font-bold text-[var(--text-primary)] mb-2 text-lg">Notifications Blocked</h4>
  ...
  return (
    <div className="w-full flex-1 flex flex-col items-center justify-center p-6 text-center">
      ...
      <h4 className="font-bold text-[var(--text-primary)] mb-2 text-lg">Enable Notifications</h4>
      <p className="text-sm text-[var(--text-secondary)] mb-6">
