  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-gray-800 border border-gray-700 rounded-lg p-4 shadow-2xl z-50 flex flex-col gap-3 animate-fade-in-up">
      <div className="flex items-start justify-between">
        <div>
          <h3 className="text-white font-semibold text-lg">Install Pinboard</h3>
          <p className="text-gray-400 text-sm mt-1">Add Pinboard to your home screen for quick and easy offline access.</p>
        </div>
      ...
      <div className="flex gap-2 justify-end mt-2">
        ...
        <button onClick={handleInstallClick} className="px-4 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded font-medium transition-colors">
          Install App
        </button>
      </div>
    </div>
